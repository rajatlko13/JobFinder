...
const AddRecruiter = (props) => {
    return ( 
        <svg version="1.1" id="Capa_1" style={props.style} width={props.width}
            xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 480 480" style={{enableBackground: 'new 0 0 480 480'}} xmlSpace="preserve">
            <g>
